      ...
      <ScrollView horizontal={false} showsVerticalScrollIndicator={false}>
        <View>
          ...
          <View style={styles.buttonCont}>
            <TouchableOpacity
              style={(styles.buttonCont, { marginTop: 25 })}
        ...
        <Text style={styles.welSum}>You're currently on track!</Text>
              ...
              <View style={styles.container3}>
                ...
                >
                  ...
                  >
                    ...
                    <Image
                      source={{
                        uri: "https://cdn-icons-png.flaticon.com/512/2933/2933502.png",
                      }}
                ...
                >
                  ...
                  >
                    ...
                    <Image
                      source={{
                        uri: "https://cdn-icons-png.flaticon.com/512/638/638949.png",
                      }}
                      style={{ width: 100, height: 100 }}
                    />
                ...
                >
                  ...
                  >
                    ...
                    <Image
                      source={{
                        uri: "https://cdn-icons-png.flaticon.com/512/1581/1581375.png",
                      }}
                      style={{ width: 100, height: 100 }}
                    />
          ...
          <View style={styles.buttonCont}>
            <TouchableOpacity
              style={(styles.buttonCont, { marginTop: 10, marginBottom: 70 })}
              onPress={() => setShouldShow(!shouldShow)}
            >
              <View style={styles.button}>
          ...
          <View>
            <Text style={styles.quickTxt}>
              You're doing <Text style={{ color: "#146CF6" }}>amazing</Text>,
              John! With each task you complete, you're contributing to{" "}
              <Text style={{ color: "#00D4B0" }}>a clean world!</Text>
            </Text>
          </View>
          ...
          <View style={styles.curPtsCont}>
            ...
            >
              Keep up the{" "}
              <Text style={{ color: "#00D4B0", fontWeight: "bold" }}>
                green
              </Text>{" "}
              work!
            </Text>
          ...
          <View style={styles.conCont}>
            <Text
              style={styles.learnTxt}
              onPress={() => setShouldShow(!shouldShow)}
            >
              Learn how we count success
            </Text>
            {shouldShow ? (
              <View style={styles.infoCon}>
                <Text style={styles.infoTitle}>How we count success:</Text>
                <Text style={styles.infoTxt}>
                  We count success on a{" "}
                  <Text style={{ fontWeight: "bold", color: "#008958" }}>
                    daily level
                  </Text>{" "}
                  using both your{" "}
                  <Text style={{ fontWeight: "bold", color: "#008958" }}>
                    compelted tasks and your smart home efficiency
                  </Text>{" "}
                  (if smart home is set up).
                </Text>

                <Text style={styles.infoTxt2}>
                  The more tasks you accomplish each day and the more
                  environmentally friendly your smart home settings are,{" "}
                  <Text style={{ fontWeight: "bold", color: "#008958" }}>
                    the higher your daily score!
                  </Text>
                </Text>
              </View>
            ) : null}
